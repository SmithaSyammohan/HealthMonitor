...
import com.example.healthmonitor.api.CoronaApi;
import com.example.healthmonitor.api.CoronaService;
import com.example.healthmonitor.data.CountriesResponse;
import com.example.healthmonitor.ui.activity.DetailActivitya;
            ...
            public void onClick(View view) {
                ...
                call.enqueue(new Callback<CountriesResponse>() {
                    ...
                    public void onResponse(Call<CountriesResponse> call, Response<CountriesResponse> response) {
                        ...
                        Intent intent = new Intent(view.getContext(), DetailActivitya.class);
